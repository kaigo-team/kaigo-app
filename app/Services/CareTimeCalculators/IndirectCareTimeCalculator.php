...
/**
 * 間接生活介助に関する要介護認定基準時間を算出するクラス
 * 時間の表示範囲：0.4～11.3分
 */
class IndirectCareTimeCalculator extends BaseCareTimeCalculator
{
    /**
     * 間接生活介助に関する要介護認定基準時間を算出する
     * 
     * @param array $answers 回答データ
     * @return float 間接生活介助に関する時間（分）
     */
    ...
    /**
     * 生活機能の中間得点が14.4以下の場合の間接生活介助時間を計算
     * 
     * @param array $answers 回答データ
     * @param float $lifeFunctionScore 生活機能の中間得点
     * @return float 間接生活介助時間（分）
     */
    ...
    /**
     * 生活機能の中間得点が14.5以上の場合の間接生活介助時間を計算
     * 
     * @param array $answers 回答データ
     * @return float 間接生活介助時間（分）
     */
